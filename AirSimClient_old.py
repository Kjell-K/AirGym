...
class AirSimClientBase:
    ...
    def getHomeGeoPoint(self):
        return GeoPoint.from_msgpack(self.client.call('getHomeGeoPoint',"Drone0"))
...
class MultirotorClient(AirSimClientBase, object):
    ...
    def armDisarm(self, arm):
        return self.client.call('armDisarm', arm,vehicle_name = "Drone0")

    def takeoff(self, max_wait_seconds = 15):
        return self.client.call('takeoff', max_wait_seconds,vehicle_name = "Drone0")
        
    def land(self, max_wait_seconds = 60):
        return self.client.call('land', max_wait_seconds,vehicle_name = "Drone0")
    ...
    def moveByAngle(self, pitch, roll, z, yaw, duration):
        return self.client.call('moveByAngle', pitch, roll, z, yaw, duration, vehicle_name = "Drone0")

    def moveByVelocity(self, vx, vy, vz, duration, drivetrain = DrivetrainType.MaxDegreeOfFreedom, yaw_mode = YawMode()):
        return self.client.call('moveByVelocity', vx, vy, vz, duration, drivetrain, yaw_mode, vehicle_name = "Drone0")

    def moveByVelocityZ(self, vx, vy, z, duration, drivetrain = DrivetrainType.MaxDegreeOfFreedom, yaw_mode = YawMode()):
        return self.client.call('moveByVelocityZ', vx, vy, z, duration, drivetrain, yaw_mode, vehicle_name = "Drone0")
    ...
    def moveOnPath(self, path, velocity, max_wait_seconds = 60, drivetrain = DrivetrainType.MaxDegreeOfFreedom, yaw_mode = YawMode(), lookahead = -1, adaptive_lookahead = 1):
        return self.client.call('moveOnPath', path, velocity, max_wait_seconds, drivetrain, yaw_mode, lookahead, adaptive_lookahead, vehicle_name = "Drone0")

    def moveToZ(self, z, velocity, max_wait_seconds = 60, yaw_mode = YawMode(), lookahead = -1, adaptive_lookahead = 1):
        return self.client.call('moveToZ', z, velocity, max_wait_seconds, yaw_mode, lookahead, adaptive_lookahead, vehicle_name = "Drone0")
    ...
    def moveToPosition(self, x, y, z, velocity, max_wait_seconds = 60, drivetrain = DrivetrainType.MaxDegreeOfFreedom, yaw_mode = YawMode(), lookahead = -1, adaptive_lookahead = 1):
        return self.client.call('moveToPosition', x, y, z, velocity, max_wait_seconds, drivetrain, yaw_mode, lookahead, adaptive_lookahead,vehicle_name = "Drone0")

    def moveByManual(self, vx_max, vy_max, z_min, duration, drivetrain = DrivetrainType.MaxDegreeOfFreedom, yaw_mode = YawMode()):
        return self.client.call('moveByManual', vx_max, vy_max, z_min, duration, drivetrain, yaw_mode,vehicle_name = "Drone0")

    def rotateToYaw(self, yaw, max_wait_seconds = 60, margin = 5):
        return self.client.call('rotateToYaw', yaw, max_wait_seconds, margin,vehicle_name = "Drone0")

    def rotateByYawRate(self, yaw_rate, duration,vehicle_name = "Drone0"):
        return self.client.call('rotateByYawRate', yaw_rate, duration,vehicle_name = "Drone0")
